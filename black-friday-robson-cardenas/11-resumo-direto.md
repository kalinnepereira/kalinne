...
| Item | Acesso |
|---|---|
| **Contos Maravilhosos** — a âncora de toda a campanha | **Vitalício** |
| Mais 10 cursos do acervo | **Vitalício** |
| **3 meses de PHI ao vivo** com o Robson | 3 meses |
...
**A data que vai em todo criativo é 12/11.** Sempre. A de alunos não se divulga.

---

# A TESE EM TRÊS LINHAS

Black Friday é **colheita, não plantio**. 91% de quem comprou o PHI acompanha o
Robson há mais de 2 anos; 62% da lista do Rei Arthur o conhece há menos de 1.
**Quem compra é a base antiga.** Não se capta lead frio nesta janela.
...
| Bloco | Período |
|---|---|
| **Corredor Polonês** (21 dias) | 29/09 – 19/10 |
| **Trailer Hollywood** revela 12/11 | 20 – 25/10 |
| **Captação geral** (18 dias) | 26/10 – 12/11 |
| **Captação alunos** (15 dias) | 27/10 – 10/11 |
| **AULA MAGNA ALUNOS** | **10/11 terça 20h30** |
| **AULA MAGNA GERAL** | **12/11 quinta 20h30** |
| Carrinho aberto | 12 – 23/11 |
| Boleto parcelado liberado | 19/11 |
...
**Duas datas ficam vazias de propósito:** 25/10 (segundo turno) e 02/11 (Finados).

---

# AGENDA DO ROBSON — BLOQUEAR AGORA
...
| A partir de dezembro | PHI com a turma nova dentro, por 3 meses |

---

# OS PRAZOS QUE NÃO PODEM ESCORREGAR
...
| **22/10** | 2ª BM e 2º número de API aprovados |
| **22/10** | Roteiro do Manifesto |
| **24/10** | Página de captura e de obrigado prontas e testadas |
| **26/10** | Abre captação geral |
| **26–27/10** | Gravação 2 |
| **03/11** | Script da aula magna pronto |
| **07/11** | PDF do Plano de Leitura e área de membros do acervo |
| **09/11** | Ensaio + **teste de compra real no checkout** |
| **10 e 12/11** | Aulas magnas |

Regra de ouro: **tráfego recebe criativo 2 dias antes de subir.** Sempre.
...
**R$ 15.000 de tráfego** — captação 70% · CP e trailer 10% · FLS 10% ·
campanha jato 5% · carrinho 5%.

⚠️ **O custo de disparo por API ainda não foi levantado.** Com 16 mil leads e
3 a 4 disparos cada, é o grosso do orçamento. É a linha mais urgente da semana.
...
**E a linha que não aparece na Black:** ~120 famílias novas dentro do PHI
decidindo renovação em fevereiro/2027. A 40%, são **R$ 69 mil de recorrente
novo**. É por isso que os 3 meses existem.

---

# O TSUNAMI DO DIA 1

70% das vendas acontecem no primeiro dia.
...
# PARA O HENRI, EM UMA TELA

**A objeção não é preço. É "não vou dar conta".**

> "Tenho que começar do zero, não sei nada de literatura, por isso não sei se
> vou conseguir acompanhar algum curso, gostaria, mas fico insegura."
> — resposta literal da pesquisa

A resposta da oferta são **os 3 meses de PHI ao vivo**: o Robson do lado da
pessoa toda semana.

**As dores, em ordem:** constância e rotina · qual livro para qual idade · fazer
o filho gostar de ler · não saber mediar · obediência · professores de escola.

**O que vende:** profundidade com linguagem simples · proximidade do Robson ·
comunidade · **a história do John Senior** (200 alunos hippies, 196 convertidos
em nove anos — o melhor cold open do projeto) · o efeito nos filhos.

**Regras:** usar a palavra "Black Friday" · deixar claro desde o dia 1 que tem
oferta · promessa na condição, não na transformação · justificar o desconto ·
...
- [ ] Agenda do Robson bloqueada
- [ ] 7 conteúdos orgânicos selecionados para o lote 1
- [ ] Card/motion final desenhado (2 versões)
- [ ] Henri começa os roteiros
- [ ] Grupo do FLS criado e tema da live de 29/09 definido
- [ ] 28/09: fecha o carrinho do PHI e antecipa a oferta da Black para quem comprou
...
1. **Queda da API** — a captação é majoritariamente API. 2ª BM até 22/10.
2. **A sala do PHI dobrar** — 300 → 420 muda a dinâmica. Decidir com o Robson.
